...
Public Class ClassBarang
    ...
    Private database As String = "barang"

    Dim connect As New MySqlConnection("server=localhost;username=root;password='';database='barang';Convert Zero Datetime=True")
    ...
    '    Public Function UpdateDataKoleksiByIODatabase(ID As Integer,
    '                                                  nama_barang As String,
    '                                                  stock_barang As Integer,
    '                                                  harga_barang As Integer,
    '                                                  tanggal_masuk_barang As String,
    ...
    '                        “stock='" & stock_barang & "', " &
    '                        “harga='" & harga_barang & "', " &
    '                        “tanggal_masuk='" & tanggal_masuk_barang & "', " &
    '                        “tanggal_kadaluarsa='" & tanggal_kadaluarsa_barang & "', " &
    '                        “WHERE id_barang='" & ID & "'"
