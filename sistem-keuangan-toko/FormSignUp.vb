Public Class FormSignUp
    Private Sub BtnSignUp_Click(sender As Object, e As EventArgs) Handles Btn_Signup.Click
    ...
    Private Sub LB_Akun_SelectedIndexChanged(sender As Object, e As EventArgs) 
